...
//              tabBarBuyer.selectedIndex = 0
            ...
            ref?.child("Favorites").child(uid).childByAutoId().updateChildValues(["Name" : "2m", "Description" : "Morning Gratitude", "Image" : "https://firebasestorage.googleapis.com/v0/b/cleanse-recipes.appspot.com/o/Morning%403x.png?alt=media&token=bd8c18b6-bcae-4f6a-82a8-be6b940fbcdb", "Headline1" : "What are you grateful for this morning?", "Headline2" : "What are you working towards? What is your goal?", "Headline3" : "What are three things you need to do today to get closer your goal?", "Headline4" : "What will make today great?",  "Popularity" : 2 ])
            
            ref?.child("Favorites").child(uid).childByAutoId().updateChildValues(["Name" : "2m", "Description" : "Today's Targets", "Image" : "https://firebasestorage.googleapis.com/v0/b/cleanse-recipes.appspot.com/o/Morning%403x.png?alt=media&token=bd8c18b6-bcae-4f6a-82a8-be6b940fbcdb", "Headline1" : "What are you grateful for this morning?", "Headline2" : "What are you working towards? What is your goal?", "Headline3" : "What are three things you need to do today to get closer your goal?", "Headline4" : "What will make today great?",  "Popularity" : 3 ])

            
            ref?.child("Favorites").child(uid).childByAutoId().updateChildValues(["Name" : "2m", "Description" : "Evening Lessons Learned", "Image" : "https://firebasestorage.googleapis.com/v0/b/cleanse-recipes.appspot.com/o/Green%403x.png?alt=media&token=67ecfae9-a494-4fbe-bb2f-793d3ebe4ddb", "Headline1" : "What happened?", "Headline2" : "What did you expect to happen?", "Headline3" : "What will you do differently next time?", "Popularity" : 4 ])
            
            ref?.child("Favorites").child(uid).childByAutoId().updateChildValues(["Name" : "2m", "Description" : "Evening Wins", "Image" : "https://firebasestorage.googleapis.com/v0/b/cleanse-recipes.appspot.com/o/Green%403x.png?alt=media&token=67ecfae9-a494-4fbe-bb2f-793d3ebe4ddb", "Headline1" : "What happened?", "Headline2" : "What did you expect to happen?", "Headline3" : "What will you do differently next time?", "Popularity" : 5 ])
            
            ref?.child("Favorites").child(uid).childByAutoId().updateChildValues(["Name" : "2m", "Description" : "Evening Gratitude", "Image" : "https://firebasestorage.googleapis.com/v0/b/cleanse-recipes.appspot.com/o/Green%403x.png?alt=media&token=67ecfae9-a494-4fbe-bb2f-793d3ebe4ddb", "Headline1" : "What happened?", "Headline2" : "What did you expect to happen?", "Headline3" : "What will you do differently next time?", "Popularity" : 6 ])
